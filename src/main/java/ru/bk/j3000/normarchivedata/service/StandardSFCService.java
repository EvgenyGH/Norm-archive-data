...
public interface StandardSFCService {
    ...
    List<StandardSFC> findAllSsfcByPeriods(List<YearMonth> yearMonths);

    List<StandardSFC> findAllSsfcByPeriodsAndSrcIds(List<YearMonth> yearMonths, List<UUID> srcIds);
}
